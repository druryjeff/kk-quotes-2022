...
function showProcessing(){
	// vars
	const defaultIcon = btnSaveFav.innerHTML;
	...
	btnSaveFav.innerHTML = progressCircle;
	...
	setTimeout(function(){
	  btnSaveFav.innerHTML = progressCheck;
	  btnSaveFav.classList.add('confirmed');
	  saveFavs();
	  // processing final stage
	  setTimeout(function(){
	    btnSaveFav.innerHTML = defaultIcon;
